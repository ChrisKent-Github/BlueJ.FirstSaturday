...
public class WriteLoops {
    ...
    public void simpleLoops() {
        ...
        //The While loop prints "Eww." while i is less than or equal to 5 and 
        //adds 1 to i each iteration.
        
        //The Do While loop print "Eww." and then subtracts 1 from i.
        //Then it reiterates this loop with i being equal to 8 until i is less
        //than 1.
    }
    ...
    public int tallyVote1() {
        ...
        Integer[] candidateCount = {0,0,0,0};
        String[] candidateList = new String[4];
        int candidateCurr = 0;
    
             for(int i = 0; i < numberOfVotes; i++){
                  w = w + 1;
                 if(!Arrays.asList(candidateList).contains(voteTallies[1])){
                    candidateList[i] = voteTallies[i];
                    candidateCount[i]++;
                 }
                 else{
                    candidateCurr = Arrays.asList(candidateList).indexOf(voteTallies[i]);
                    candidateCount[candidateCurr]++;
                 }
                }
                System.out.println("Votes:\n");
            for(int i = 0; i < candidateCount.length; i++){
                System.out.println(candidateList[i] + candidateCount[i] + "\n");
            }
